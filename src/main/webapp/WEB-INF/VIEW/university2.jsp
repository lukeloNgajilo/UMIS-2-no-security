...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="container-fluid">
    ...
    <c:forEach items ="${university}" var="university" >
            ...
            <td>   <button  type="submit"  class="text-warning"><a href="/edituniversity?id=${university.id}">EDIT</a></button> </td>
             <td>   <button type="submit"  class="text-warning"><a href="/deleteuniversity?id=${university.id}">DELETE</a></button> </td>
             </tr>
 -
                 </c:forEach>
       </table>
