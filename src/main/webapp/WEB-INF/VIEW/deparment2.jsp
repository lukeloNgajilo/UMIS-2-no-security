...
<tr>
   ...
   <c:forEach items ="${deparment}" var="deparment" >
    ...
    <td>${deparment.HOD}</td>
    <td>  <button  type="submit"  class="text-warning">  <a href="/editdeparment?id=${deparment.id}">EDIT</a> </button> </td>
    <td>  <button type="submit"  class="text-warning"> <a href="/deletedeparment?id=${deparment.id}">DELETE</a> </button> </td>
</tr>
