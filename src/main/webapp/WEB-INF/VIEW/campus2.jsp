             ...
             <tr>
                ...
                <td>${campus.CName}</td>
                 <td>${campus.location}</td>  
                  <td>${campus.region}</td>
              <td>${campus.getContacts()}</td>
                       <td>${campus.website}</td>
         
            <td>   <button  type="submit"  class="text-warning">  <a href="/editcampus?id=${campus.id}">EDIT</a> </button> </td>
             <td>   <button type="submit"  class="text-warning"><a href="/deletecampus?id=${campus.id}">DELETE</a> </button> </td>
             </tr>
